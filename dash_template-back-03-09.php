...
<div class="container-fluid panel" id="work-area" style="height: 96px;">
    ...
    <!-- end help text -->
        ...
        <div class="row" style="margin-top: 25px;">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" >
                <!-- -->
                <div class="padding-24" ng-click="ActivatePanel('left')" ng-class="{'well': active_panel == 'left', 'panel':active_panel == 'right'}" style="min-height: 500px;">

                <center class="main-text text-weight-400"><h3>Форми для гостей</h3></center>
                ...
                <div class="form-group label-floating margin-top-72">
                    <label class="control-label main-text text-16" for="form-count">Кількість гостей</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group label-floating">
                                  <div class="checkbox">
                                  <label class="">
                                    Дитина <input type="checkbox" ng-model="cust.isChild">
                                  </label>
                                  </div>
                                </div><!-- end peron fio -->
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" >
                ...
                <!-- -->
                <div class="padding-24" ng-click="ActivatePanel('right')" ng-class="{'well': active_panel == 'right', 'panel': active_panel=='left'}" style="min-height: 500px;">
                <center class="main-text text-weight-400" ><h3>Готельна форма</h3></center>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <span class="main-text text-weight-400 text-16">Період</span>
                    </div>
                </div>
        ...
        <div class="row ">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" ng-show="IsTour()">
                <div class="panel panel-info">
                    <div class="panel-heading">Tour info</div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" ng-show="IsHotel()">
                <div class="panel panel-info">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" ng-show="IsApartments()">
                <div class="panel panel-info">
                    <div class="panel-heading">Apartments info</div>
                    <div class="panel-body">
